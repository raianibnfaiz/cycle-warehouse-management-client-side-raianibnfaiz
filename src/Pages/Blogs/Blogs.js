    ...
    return (
        <div className="blogs w-75 mx-auto p-4 mt-4 mb-4">
            ...
            <div className='d-flex flex-column  '>
                ...
                <div className="container mb-5 border second-question p-4 mb-4">
                ...
                <div className="container mb-5 border third-question p-4 mb-4">
